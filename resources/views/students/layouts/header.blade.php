                ...
                <ul class="navbar-nav navbar-nav-hover align-items-lg-center right-text">
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" data-toggle="dropdown">
                            <span class="nav-link-inner-text">الدراسة</span>
                            <span class="fas fa-angle-down nav-link-arrow ml-2"></span>
                        </a>
                        <ul class="dropdown-menu right-text">
                            <li><a class="dropdown-item" href="{{ route('schedule.tomorrow-schedule') }}">غدا </a></li>
                            <li><a class="dropdown-item" href="{{ route('schedule.student-schedule') }}">الجدول الدراسي</a></li>
                            <li><a class="dropdown-item" href="{{ route('schedule.get') }}">التكاليف</a></li>
                    ...
                    <li class="nav-item dropdown">
                        <a href="#" class="nav-link" data-toggle="dropdown">
                            <span class="nav-link-inner-text">الاختبارات</span>
                            <span class="fas fa-angle-down nav-link-arrow ml-2"></span>
                        </a>
                        <ul class="dropdown-menu right-text">
                            <li><a class="dropdown-item" href="{{ route('exam.index') }}">الاختبارات</a></li>
                            <li><a class="dropdown-item" href="{{ route('exam.my-exam') }}">اختباراتي</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu right-text">
                            ...
                            <li><a class="dropdown-item" href="{{ route('channel.index') }}">القناة</a></li>
                        </ul>
                    </li>
                    @if (session('role_id') == 7)
                        <li class="nav-item dropdown">
                            <a href="#" class="nav-link" data-toggle="dropdown">
                                <span class="nav-link-inner-text">المندوب</span>
                                <span class="fas fa-angle-down nav-link-arrow ml-2"></span>
                            </a>
                            <ul class="dropdown-menu right-text">
                                <li><a class="dropdown-item" href="{{ route('attendances.index') }}">اخذ الحضور</a></li>
                                <li><a class="dropdown-item" href="{{ route('hall.hall-booking') }}">حجز القاعات</a></li>
                            </ul>
                        </li>
                    @endif
                </ul>
