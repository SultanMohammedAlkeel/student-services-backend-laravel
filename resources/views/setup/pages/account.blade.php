                ...
                <div class="col-12 col-md-8 col-lg-6 justify-content-center">
                    <div class="card bg-primary shadow-soft border-light p-4">
                        <div class="card-header text-center pb-0">
                            <h2 class="mb-0 h5 custom-font">انشاء حساب مسوؤل</h2>
                        </div>
                        <div class="card-body">
                            <form method="post" action="{{ route('user.store') }}" enctype="multipart/form-data" >
                                ...
                                <div class="form-group">
                                    <select class="custom-select my-1 mr-sm-2" name="gender">  
                                        <option value="ذكر" {{ 'ذكر' == old('gender') ? 'selected' : '' }}>ذكر</option>
                                        <option value="انثى" {{ 'انثى' == old('gender') ? 'selected' : '' }}>انثى</option>
                                    </select>
                                </div>
                                <!-- End of Form -->
                                <!-- Form -->
