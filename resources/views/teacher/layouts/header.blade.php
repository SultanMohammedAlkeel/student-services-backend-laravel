                ...
                <ul class="navbar-nav navbar-nav-hover align-items-lg-center right-text">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu right-text">
                            <li><a class="dropdown-item" href="{{ route('schedule.tomorrow') }}">غدا </a></li>
                            <li><a class="dropdown-item" href="{{ route('schedule.get') }}">محاضراتي</a></li>
                            <li><a class="dropdown-item" href="{{ route('schedule.level') }}">الطلاب</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu right-text">
                            <li><a class="dropdown-item" href="{{ route('exam.index') }}">رفع اختبار</a></li>
                            <li><a class="dropdown-item" href="{{ url('/my-book') }}">رفع الدرجات</a></li>
                            <li><a class="dropdown-item" href="{{ url('/my-book') }}">التظلمات</a></li>
            ...
            <div class="d-flex align-items-center">
                <div class="dropdown pl-1">
                    ...
                    <div class="dropdown-menu dropdown-menu-md rtl-layout" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item gap-btwn" href="{{   url('user-mode') }}">الاشعارات<span class="fa-solid fa-user-tie"></span></a>
                        <a class="dropdown-item gap-btwn" href="{{   url('user-mode') }}">الرسائل<span class="fa-solid fa-user-tie"></span></a>
