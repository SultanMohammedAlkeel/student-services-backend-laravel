                    ...
                    <div class="card bg-primary shadow-soft border-light p-4">
                        ...
                        <div class="card-body">
                            <form method="post" action="sign">
                                @csrf
                                <!-- Form -->
                                <div class="invalid-feedback show right-text">{{ $errors->first('card') }}</div>
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        <input class="form-control" name="card" placeholder="رقم البطاقة" aria-label="Input group" type="text">
                                ...
                                <div class="form-group">
                                    <div class="input-group mb-4">
                                        <input class="form-control" name="password" placeholder="رمز التفعيل" type="password" aria-label="Password">
                                        <div class="input-group-append">
