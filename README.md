...
### 🔐 Login Page
![Login](screenshots/واجهه%20تسجيل%20الدخول%20للموقع.png)

### 🏠 Landing Page
![Landing](screenshots/public%20landing%20page.png)

### 📋 Available Services
![Services](screenshots/الخدمات%20المتوفره%20والمستعرضه%20في%20صفحه%20الهبوط.png)

### 👨‍🎓 Student Registration
![Student Register](screenshots/واجهه%20انشاء%20حساب%20طالب.png)

### 👨‍🏫 Teacher Dashboard
![Teacher Panel](screenshots/الواجهه%20الترحيبيه%20للاستاذ.png)

### 🛠️ Admin Dashboard
![Admin Panel](screenshots/الواجهه%20الرئيسيه%20للمسؤولين.png)

### 🏫 University Setup
![University Setup](screenshots/تهيئه%20بيانات%20الجامعه%20من%20كليات%20ومباني%20واسجلات%20الطلاب%20وغيرها.png)

### 📅 Academic Schedule Setup
![Schedule](screenshots/واجهه%20اضافه%20بيانات%20الجدول%20الدرسي%20لقسم%20ما%20في%20ترم%20محدد.png)

### 📚 Library Management
![Library](screenshots/واجهه%20اداره%20موارد%20المكتبه.png)

### 💬 Chat System
![Chat](screenshots/واجهه%20الدردشات%20ويب.png)

### 🧪 Exam Results
![Exam Result](screenshots/نتيجة%20الاختبار.png)
